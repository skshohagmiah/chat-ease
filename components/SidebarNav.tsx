...
const session = await getAuthSession()
  ...
  return (
    <nav className="bg-slate-600 rounded-md md:rounded-none flex w-full h-16 justify-around items-center bottom-0  md:flex-col fixed md:top-0 md:justify-start md:h-full md:pt-4 md:space-y-6 md:pb-2 md:w-16 " >
